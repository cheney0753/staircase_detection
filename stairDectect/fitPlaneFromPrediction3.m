function [xyzStairPlane, stairsEdges, supportPoints] = fitPlaneFromPrediction3(xyzPoints, uvdPoints, edgeCandidates,predictedPlane,uvdGP,epsilon)
...
[inls , inlID]= sort(allPointsOnEdge(:,3));
